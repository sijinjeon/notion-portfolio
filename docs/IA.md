...
│   ├── /projects/[slug-1]                # 동적 라우트
│   ├── /projects/[slug-2]
│   ├── /projects/[slug-3]
│   └── ...
│
├── /about (선택)                         # PageType: "About"
│   └── 소개 페이지
│
...
| 레벨 | 페이지 | PageType | 경로 | 설명 |
|------|--------|----------|------|------|
| 1 | 홈 | Home | `/` | 메인 페이지, 프로젝트 목록 표시 |
| 2 | 프로젝트 상세 | Project | `/projects/[slug]` | 개별 프로젝트/블로그 게시물 |
| 1 | 소개 | About | `/about` | 자기소개 페이지 (선택) |
| - | Footer | Footer | - | 모든 페이지 하단 컴포넌트 |
...
### 5.1. 주 네비게이션 (Primary Navigation)
...
|--------|------|-----------|------|
| 홈 / Home | `/` | 항상 | 메인 페이지 |
| 소개 / About | `/about` | About 페이지가 있는 경우 | 선택적 |
| 연락 / Contact | `mailto:` 또는 외부 링크 | 선택적 | Footer나 About에서 관리 |
